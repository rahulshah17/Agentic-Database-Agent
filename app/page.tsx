...
import GrammyList from '@/components/GrammyList'
...
const [isSidebarVisible, setIsSidebarVisible] = useState(true)
  ...
  const [refreshRecentlyPlayed, setRefreshRecentlyPlayed] = useState(0)
  const [ShowGrammyList, setShowGrammyList] = useState(false)
  ...
  const handleSongAdded = () => {
    // Trigger refresh of recently played list
    setRefreshRecentlyPlayed(prev => prev + 1)
  }
